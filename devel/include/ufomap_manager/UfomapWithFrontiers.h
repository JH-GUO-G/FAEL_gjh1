...
struct Printer< ::ufomap_manager::UfomapWithFrontiers_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ufomap_manager::UfomapWithFrontiers_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "local_frontiers: ";
    if (v.local_frontiers.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.local_frontiers.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::ufomap_manager::CellCode_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.local_frontiers[i]);
    }
    if (v.local_frontiers.empty() || false)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "global_frontiers: ";
    if (v.global_frontiers.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.global_frontiers.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::ufomap_manager::CellCode_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.global_frontiers[i]);
    }
    if (v.global_frontiers.empty() || false)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "changed_cell_codes: ";
    if (v.changed_cell_codes.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.changed_cell_codes.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::ufomap_manager::CellCode_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.changed_cell_codes[i]);
    }
    if (v.changed_cell_codes.empty() || false)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "known_cell_codes: ";
    if (v.known_cell_codes.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.known_cell_codes.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::ufomap_manager::CellCode_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.known_cell_codes[i]);
    }
    if (v.known_cell_codes.empty() || false)
      s << "]";
    if (true || !indent.empty())
