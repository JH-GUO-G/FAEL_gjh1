...
struct Printer< ::planner::RoadMapMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::planner::RoadMapMsg_<ContainerAllocator>& v)
  {
    if (false || !indent.empty())
      s << std::endl;
    s << indent << "id_point_pair_list: ";
    if (v.id_point_pair_list.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.id_point_pair_list.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::planner::IdPointPair_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.id_point_pair_list[i]);
    }
    if (v.id_point_pair_list.empty() || false)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "edge_pair_list: ";
    if (v.edge_pair_list.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.edge_pair_list.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::planner::EdgePair_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.edge_pair_list[i]);
    }
    if (v.edge_pair_list.empty() || false)
      s << "]";
  }
